...
import org.example.functions.AuthDataFunc;
...
public class EditEmployee {
    ...
    void initialize() {
        ...
        addBtn.setOnAction(actionEvent -> {
            ...
            if (dataColumn.getValue() != null) {
                EmployeeFunc.editEmployee(id, nameColumn.getText(), phone, AuthDataFunc.getDataByLogin(dataColumn.getValue()));
    ...
    public void setEmployee(EmployeeEntity employee){
        id = employee.getId();
        nameColumn.setText(employee.getName());
        phoneColumn.setText(employee.getPhoneNumber());
        dataColumn.setValue(employee.getAuthData().getLogin());
    }
